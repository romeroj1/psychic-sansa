...
full_archive_name = backuploc  + "/Full-backup-" + datetime.datetime.now().strftime("%Y%m%d%H%M") + ".tar.gz"
inc_archive_name = backuploc  + "/Inc-backup-" + datetime.datetime.now().strftime("%Y%m%d%H%M") + ".tar.gz"
